...
class GuidanceDocsTests(unittest.TestCase):
    ...
    def test_skill_md_stays_slim_but_indexes_full_guidance(self):
        ...
        self.assertIn("原始语言和文字系统", skill_md)
        self.assertIn("翻译、英文化或罗马化", skill_md)
        ...
        self.assertIn("decide_reference_extraction", skill_md)
        self.assertIn("review_reference_quality", skill_md)
        self.assertIn("quality_directives", skill_md)
        self.assertIn("conferenceName", skill_md)
        self.assertIn("publicationTitle", skill_md)
        self.assertIn("prepare_reference_metadata_enrichment", skill_md)
        self.assertIn("persist_reference_metadata_enrichment", skill_md)
        self.assertIn("metadata_context_text", skill_md)
        self.assertIn("reference_preprocess_quality", skill_md)
        self.assertIn("file_quality_low", skill_md)
        ...
        self.assertIn("### 18. `render_and_validate --mode render`", skill_md)
    ...
    def test_runtime_docs_preserve_guidance_without_history_noise(self):
        ...
        core_instruction = self.read("literature-digest/assets/core_instruction.md")
        ...
        self.assertIn("`reference_preprocess_quality: object|null`", gate_interface)
        self.assertIn("stage4_reference_quality", gate_interface)
        self.assertIn("原始语言和文字系统", core_instruction)
        self.assertIn("翻译、英文化或罗马化", core_instruction)
        self.assertIn("original language/script", gate_interface)
        ...
        self.assertIn("decide_reference_extraction", step_04)
        ...
        self.assertNotIn("line-first-v171", step_04)
        self.assertIn("file_quality_low", step_04)
        self.assertIn("cjk_type_marker_entry", step_04)
        ...
        self.assertIn("`prepare_citation_workset` 必须在 `persist_reference_metadata_enrichment` 后运行", step_04)
        ...
        self.assertIn("placeholder_title", step_04)
        self.assertIn("Reference metadata enrichment", step_04)
        self.assertIn("subagents", step_04)
        self.assertIn("conferenceName", step_04)
        self.assertIn("publicationTitle", step_04)
        self.assertIn("DOI", step_04)
        self.assertIn("unknown", step_04)
        self.assertIn("N.A.", step_04)
        self.assertIn("review_reference_quality", step_04)
        self.assertIn("accept_warning", step_04)
        self.assertIn("Unicode-aware tokenizer", step_04)
        self.assertIn("基于深度学习的文本分类方法", step_04)
        self.assertIn("不得改写为 `Text classification method based on deep learning`", step_04)
        ...
        self.assertIn("Reference-free mode", step_05)
        self.assertIn("references_abandoned_file_quality_low", step_05)
        ...
        self.assertIn("## `prepare_references_workset`", stage_interface)
        self.assertIn("## `persist_reference_entry_splits`", stage_interface)
        self.assertIn("## `decide_reference_extraction`", stage_interface)
        self.assertIn("## `prepare_reference_metadata_enrichment`", stage_interface)
        self.assertIn("## `persist_reference_metadata_enrichment`", stage_interface)
        ...
        self.assertIn("conferenceName", stage_interface)
        self.assertIn("DOI", stage_interface)
        self.assertIn("rich metadata 不在本步强制完成", stage_interface)
        self.assertNotIn("preprocess_version", stage_interface)
        self.assertIn("reference-free mode", stage_interface)
