...
class GuidanceDocsTests(unittest.TestCase):
    ...
    def test_skill_md_stays_slim_but_indexes_full_guidance(self):
        ...
        self.assertIn("### 9. `render_and_validate --mode render`", skill_md)
    ...
    def test_runtime_docs_preserve_guidance_without_history_noise(self):
        ...
        self.assertIn("`--mode render` 不得再接受显式", step_06)
        ...
        self.assertIn("entry_start", stage_interface)
    ...
    def test_templates_preserve_original_intent(self):
        ...
        self.assertIn("按引用编号/作者-年份列举", citation_md)
    ...
    def test_repo_level_traceability_docs_exist(self):
        ...
        expected = subprocess.run(
            ["git", "show", "HEAD:literature-digest/SKILL.md"],
            cwd=REPO_ROOT,
        ...
        self.assertEqual(expected, legacy.read_text(encoding="utf-8"))
