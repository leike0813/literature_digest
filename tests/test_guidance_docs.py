...
class GuidanceDocsTests(unittest.TestCase):
    ...
    def test_skill_md_stays_slim_but_indexes_full_guidance(self):
        ...
        self.assertIn("最低字段只是无证据时的下限", skill_md)
        ...
        self.assertIn("### 16. `render_and_validate --mode render`", skill_md)
    ...
    def test_runtime_docs_preserve_guidance_without_history_noise(self):
        ...
        self.assertIn("rich_metadata_evidence_missing", step_04)
        ...
        self.assertIn("最低字段只是无证据时的下限", stage_interface)
